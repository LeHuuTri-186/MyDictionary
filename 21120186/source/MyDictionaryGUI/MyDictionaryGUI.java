...
public class MyDictionaryGUI extends javax.swing.JFrame {
    ...
    public MyDictionaryGUI() {
        ...
        this.aboutMe.addMenuListener(new MenuListener() {
            @Override
        ...
        this.searchHistory.addActionListener(e -> {
            ...
            his.forEach(l->{System.out.println(l.getWord() + " " + l.getSearchDate().toString());});
    ...
    private void initComponents() {
        ...
        addWordBtn.setBackground(new java.awt.Color(0, 205, 0));
        addWordBtn.setFont(new java.awt.Font("SVN-Aguda", 0, 13)); // NOI18N
        addWordBtn.setForeground(new java.awt.Color(255, 255, 255));
        addWordBtn.setText("Add Word");
        ...
        AZBtn.setForeground(new java.awt.Color(255, 255, 255));
        AZBtn.setText("A - Z");

        buttonGroup2.add(ZABtn);
        ZABtn.setFont(new java.awt.Font("SVN-Aguda", 0, 13)); // NOI18N
        ZABtn.setForeground(new java.awt.Color(255, 255, 255));
        ZABtn.setText("Z - A");
